...
- 菜单栏常驻项不可作为唯一入口。刷新、语言切换、新手引导、联系作者、关于与反馈、提交反馈和退出必须同时能从桌面胶囊展开面板进入。
...
- 展开面板必须在“本周压力”下方提供低优先级操作区，并备份状态栏菜单里的主要操作：打开状态栏菜单、刷新、显示/隐藏悬浮胶囊、查看新手引导、语言切换、联系作者、关于与反馈、提交反馈和退出。状态栏不可见或被系统折叠时，用户仍能操作产品。
...
- 在简中、繁中、英文下分别点击展开面板操作区里的每个按钮，确认动作触发且面板不会被误收起。
