...
- 悬浮面板“更多操作”不得使用依赖悬停路径的语言二级菜单；简体中文、繁體中文和 English 必须作为同一个主菜单里的一级动作直接可达。
...
- 在简中、繁中、英文下分别点击展开面板操作区里的“立即刷新”“提交反馈”“更多操作”，确认三种语言动作直接位于“更多操作”主菜单、无需悬停二级菜单，并确认动作触发且面板不会被误收起。
