...
- `state`：enough / running_fast / may_run_out / exhausted / calibrating / unavailable
- `used_delta_percent`
- `delta_minutes`
...
- `provider`：codex
- `status`：enough / running_fast / may_run_out / exhausted / calibrating / unavailable
