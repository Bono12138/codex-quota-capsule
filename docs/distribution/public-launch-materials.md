...
当前这个内测版本已经支持 macOS 原生悬浮胶囊、菜单栏图标、详情面板、自动刷新、手动刷新、三语界面、首次引导、统一反馈入口、Codex 整理提示词，以及本地历史和可选的产品改进数据。它默认从本机读取，本机计算。prompt、session、token、cookie、代码内容、文件路径这些都留在你的电脑上。
